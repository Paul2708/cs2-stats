        ...
        if (event.getName().equals("info")) {
            ...
            String message = """
                    **👋 Hello %s!**
                    ...
                    🔹 **Steam ID** – Your unique Steam ID associated with your Steam account (e.g., `76561198106142637`, `sharebin`)
                    🔹 **Share Code** – Code that references the game that is furthest back (e.g., `CSGO-XXXXX-XXXXX-XXXXX-XXXXX-XXXXX`)
                    🔹 **Authentication Code** – Generated by CS2 used to fetch your newest share codes (e.g., `XXXX-XXXX-XXXX`)
